    ...
    return (
        <div className="register-container">
            ...
            <form className="register-form" onSubmit={handleSubmit}>
                ...
                <input type="text" name="name" placeholder={t('register.nameLabel')} onChange={handleChange} required />
                <h3>{t('register.emailLabel')}</h3>
                <input type="email" name="email" placeholder={t('register.emailLabel')} onChange={handleChange} required />
                <h3>{t('register.passwordLabel')}</h3>
                <input type="password" name="password" placeholder={t('register.passwordLabel')} onChange={handleChange} required />
                <button type="submit">{t('register.button')}</button>

                <h6>{t('register.hasAccount')} <Link to="/login">{t('register.loginLink')}</Link></h6>
            </form>
